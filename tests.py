...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow(self):
        u1 = User(username='duong', email='duong@duong.com')
        u2 = User(username='quang', email='quang@quang.com')
        db.session.add(u1)
        db.session.add(u2)
        db.session.commit()
        ...
        self.assertEqual(u1.followed.first().username, 'duong')
        self.assertEqual(u2.followers.count(), 1)
        self.assertEqual(u2.followers.first().username, 'quang')
    ...
    def test_follow_posts(self):
        ...
        u1 = User(username='duong', email='duong@duong.com')
        u2 = User(username='quang', email='quang@quang.com')
        u3 = User(username='huy', email='huy@example.com')
        u4 = User(username='thoang', email='thoang@example.com')
